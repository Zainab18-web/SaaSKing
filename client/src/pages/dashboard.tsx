...
import { Search, Download, ExternalLink, Loader2, TrendingUp, Link as LinkIcon, Hash, History } from "lucide-react";
...
export default function Dashboard() {
  ...
  // Mock history data
  const history = [
    { url: "https://stripe.com", date: "2 hours ago", links: 1240 },
    { url: "https://vercel.com", date: "1 day ago", links: 850 },
    { url: "https://replit.com", date: "2 days ago", links: 2100 },
  ];
  ...
  const handleExport = () => {
    toast({
      ...
      description: "Your CSV report is being generated and will start downloading shortly.",
    });
    setTimeout(() => {
      toast({
        title: "Export Complete",
        description: "backlinks_report.csv has been downloaded.",
        variant: "default",
      });
    }, 2000);
  };
    ...
    <div className="container mx-auto py-8 px-4 max-w-6xl space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2">
           <Button variant="outline" onClick={handleExport} disabled={!hasSearched && activeTab === 'extract'}>
             <Download className="mr-2 h-4 w-4" /> Export CSV
           </Button>
        </div>
      </div>

      <Tabs defaultValue="extract" className="w-full" onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-2 max-w-[400px]">
          <TabsTrigger value="extract">Extraction</TabsTrigger>
          <TabsTrigger value="history">History</TabsTrigger>
        </TabsList>

        <TabsContent value="extract" className="space-y-8 mt-6">
          {/* Search Section */}
        ...
        <TabsContent value="history" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <History className="h-5 w-5" /> Recent Extractions
              </CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Links Found</TableHead>
                    ...
                    <TableRow key={i}>
                      ...
                      <TableCell className="text-right">
                        <Button variant="ghost" size="sm" onClick={() => {
                          ...
                          handleExtract({ preventDefault: () => {} } as any);
                        }}>
                          View Report
                        </Button>
                      </TableCell>
